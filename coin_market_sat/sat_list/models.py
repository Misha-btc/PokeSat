...
def update_sat(sender, instance, **kwargs):
    ...
    total_price = sum(t.listed_price for t in transactions)
    total_satribute = sum(t.satribute_amount for t in transactions)
    avg_price = total_price / total_satribute / 100000000 * 35000
    sat = instance.sat
